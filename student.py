...
def Level_two_Painting(One):
    ...
    while ClayFace != "the painting" and ClayFace != "painting" and ClayFace != "paint" and ClayFace != "":
        ClayFace = input("Enter where you'd like to investigate:\n")
        clayface = clayface.lower()
        if ClayFace == "the painting" or "painting" or "paint":
           ClayFace = True
           return One 
        else:
            print("Not quite")
...
def Level_two_Painting_exit(One):
    print("Riddler: wow I'm impressed but how will you get through.")
